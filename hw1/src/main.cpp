...
bool Initialize() {
    ...
    g_window = glfwCreateWindow(g_width, g_height, "天哥爱学习", nullptr, nullptr);
    if (g_window == nullptr) {
    ...
    while (!glfwWindowShouldClose(g_window)) {
        ...
        if (ImGui::Begin("Config")) {
            ...
            if(ImGui::Button("clear")) {
                in_pos.clear();
                inter_poly.pos.clear();
                inter_gauss.pos.clear();
                approx_poly.pos.clear();
                approx_norm.pos.clear();
            }
...
//                inter_gauss.pos = MathUtil::InterpolationGauss(in_pos, inter_gauss.sigma2, inter_gauss.m, lb, rb, step);
                inter_gauss.pos = MathUtil::InterpolationGauss1(in_pos, inter_gauss.sigma2, inter_gauss.m, lb, rb, step);
...
//                approx_poly.pos = MathUtil::ApproximationPolygon(in_pos, approx_poly.m, lb, rb, step);
                approx_poly.pos = MathUtil::ApproximationPolygon1(in_pos, approx_poly.m, lb, rb, step);
